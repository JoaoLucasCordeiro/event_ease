                          ...
                          <FormControl>
                            <div className="flex items-center">
                              <label htmlFor="isFree"
                                className="whitespace-nowrap pr-3 leading-none peer-disable:cursor-not-allowed peer-disabled:opacity-70">
                                Gratuito
                              </label>
                              <Checkbox
                                id="isFree"
              ...
              <FormItem className="w-full">
                <FormControl>
                  <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                    ...
                    <Input placeholder="Site do evento" {...field} className="input-field" />
                  </div>
