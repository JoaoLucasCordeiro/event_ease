  ...
  return (
    <>
      <section className=" bg-primary-50 bg-dotted-pattern bg-cover bg-center py-5 md:py-10">
        <h3 className="wrapper h3-bold text-center sm:text-left ">Detalhes de venda</h3>
      </section>

      <section className="wrapper mt-8">
        <Search placeholder="Pesquisar nome de comprador..." />
      </section>
        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              <th className="min-w-[250px] py-3 text-left">ID da compra</th>
              <th className="min-w-[200px] flex-1 py-3 pr-4 text-left">Nome do evento</th>
